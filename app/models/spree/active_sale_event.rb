...
module Spree
  class ActiveSaleEvent < Spree::SaleEvent
    ...
    validates :name,  :eventable_id, :start_date, :end_date, :active_sale_id, :presence => true
    ...
    def update_permalink
      ...
      self.permalink = [prefix[self.eventable_type], self.eventable.permalink].join("/") unless self.eventable.nil? || self.eventable_type == "Spree::Product"
    end
